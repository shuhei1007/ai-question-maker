  ...
  return (
    <div className="app-shell">
      <header className="site-header">
        ...
        <p className="brand-subtitle">質問文作成メーカー</p>
        <a className="how-link" href="#how-to-use">
        ...
        <section className="workspace" aria-label="質問文作成フォーム">
          <div className="form-panel">
            <div className="panel-heading">
              <div>
                ...
                <h2>あなたのご状況を教えてください</h2>
              </div>
              <div
                className="progress"
                aria-label={`${completed}/5 項目入力済み`}
              >
            ...
            <div className="fields">
              {fieldDefinitions.map((field) => {
                ...
                return (
                  <div
                    className={`field-group ${isCode ? "code-field" : ""}`}
                    key={field.key}
                  >
                    <label htmlFor={field.key}>
                      ...
                      <span className="field-copy">
                        <b>
                          {field.title}
                          {isCode && <small className="optional">任意</small>}
                        </b>
            ...
            <div className="form-actions" aria-label="入力内容の操作">
              <button
                type="button"
                className="form-action-button example-button"
                onClick={() => setForm(exampleForm)}
              >
                <span className="form-action-icon" aria-hidden="true">
                  <Lightbulb size={20} />
                </span>
                <span className="form-action-copy">
                  <strong>入力例をセット</strong>
                  <small>5項目すべてに例文を入れます</small>
                </span>
              </button>
              <button
                type="button"
                className="form-action-button reset-button"
                onClick={reset}
              ...
              >
                ...
                <span className="form-action-copy">
                  <strong>入力内容をクリア</strong>
                  <small>すべての項目を空に戻します</small>
                </span>
              </button>
            </div>
          </div>
          ...
          <aside className="preview-panel" aria-live="polite">
            ...
            <p className="privacy-note">
              <span aria-hidden="true">●</span> 入力内容は保存・送信されません
            </p>
          </aside>
        </section>
